...
class ColladaParser {
 ...
 private:
  ...
  static bool parse_objmesh(std::ifstream& in, PolymeshInfo& polymesh);
  static bool parse_mtl(std::ifstream& in, PolymeshInfo& polymesh);
...
class ColladaWriter {
 public:
  ...
  static void writeGeometry(std::ofstream& out, DynamicScene::Scene& scene);
