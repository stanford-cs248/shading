#ifndef CS248_DYNAMICSCENE_AREALIGHT_H
#define CS248_DYNAMICSCENE_AREALIGHT_H
...
class AreaLight : public SceneLight {
 public:
    ...
    StaticScene::SceneLight* getStaticLight() const {
        StaticScene::AreaLight* l = new StaticScene::AreaLight(spectrum, position, direction, dim_x, dim_y);
        return l;
    }
...
#endif  // CS248_DYNAMICSCENE_AREALIGHT_H
